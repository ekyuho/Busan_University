...
def on_message(client, _t, msg):
    ...
    d=json.loads(dstr)
    body=[ts, d['T'],d['H'],d['Hpa'],d['Alt'],d['CO2'],d['Gas'],d['VOC'],d['Nox'],d['PM25'],d['PM10'],d['serial']]
    if not os.path.isfile(FILE):
        with open(FILE, 'a') as f: f.write('Time,Temp,Humid,Pressure,Altitude,CO2,Gas,VOC,NOX,PM2.5,PM10,Serial\n')
